(
    ...
    (let result (apply-twice double 3))
    ...
    (let squares (map-array numbers square))
    ...
    (process-data "hello" handle-success handle-error)
    (process-data "" handle-success handle-error)
    ...
    (let evens (filter-array data is-even))
    (console.log "Evens:" evens)
    
    (let squared (map-array evens square))
    (console.log "Squared:" squared)
    
    (let total (reduce-array squared add 0))
