...
(
    ...
    (console.log "shorthand:" (is-match "\\d+" "id-42"))
    ...
    (console.log "escaped dot:" (is-full-match "v1\\.2" "v1.2"))
    (console.log "escape is literal:" (is-full-match "v1\\.2" "v1x2"))
    ...
    (console.log "count:" (count-matches "\\d+" "a1 b22 c333"))
    (for :each m :from (find-all "\\d+" "a1 b22 c333") :then (
        (console.log "  match:" m.value)
    ))

    ;; -- something real ----------------------------------------------------------------------------

    (let email-pattern "[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]+")
    ...
    (console.log "phone:" (is-match "\\(\\d\\d\\d\\)\\s+\\d\\d\\d\\-\\d\\d\\d\\d" "call (123) 456-7890"))
)
