...
(
    ...
    (console.log '"depth        = {(depth p)}")
    (console.log '"size         = {(size p)}")
    (console.log (+ "free-vars    = " (join-sp (free-vars p))))

    (console.log "-- predicates --")
    (console.log '"is-sum p           = {(is-sum p)}")
    (console.log '"is-product (3*x)   = {(is-product (mul (inum 3) x))}")
    (console.log '"is-power (x^2)     = {(is-power (pow x (inum 2)))}")
    (console.log '"is-integer 5       = {(is-integer (inum 5))}")
    (console.log '"is-symbol x        = {(is-symbol x)}")

    (console.log "-- structural equality --")
    (console.log '"equal p p          = {(equal p p)}")
    (console.log '"equal x^2 x^3      = {(equal (pow x (inum 2)) (pow x (inum 3)))}")
    ...
    (ye1.set "y" 1.0)
    (let empty (make-env))
    (console.log '"p(2)               = {(eval p at2)}")
    (console.log '"p(0)               = {(eval p at0)}")
    (console.log '"q(1) [= p(2)]      = {(eval q ye1)}")
    (console.log '"eval 2^10          = {(eval (pow (inum 2) (inum 10)) empty)}")
    (console.log '"eval sin(0)        = {(eval (sin (rnum 0.0)) empty)}")
    (console.log '"eval cos(0)        = {(eval (cos (rnum 0.0)) empty)}")
    (console.log '"eval log(1)        = {(eval (log (rnum 1.0)) empty)}")
    (console.log '"eval exp(1) (6dp)  = {(fixed (eval (exp (rnum 1.0)) empty) 6)}")
    (console.log '"eval 2^0.5 (6dp)   = {(fixed (eval (pow (inum 2) (rnum 0.5)) empty) 6)}")
    ...
    (console.log '"is-call h          = {(is-call h)}")
