...
examples/       383 .lisp programs. This is the end-to-end suite, not a demo folder.
...
Baseline to hold, measured at the indexer-combination guard (2026-07-31): **C 326 passing /
0 failing / 2 refused / 0 not-yet**, over a 383-file total (13 library, 1 fixture, 33 negative).
...
new refusal *among the 383* is a regression, not a backlog item, and should be read that way.
