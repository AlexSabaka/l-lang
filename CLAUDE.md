...
examples/       380 .lisp programs. This is the end-to-end suite, not a demo folder.
...
Baseline to hold, measured at the defcast-discipline guard (2026-07-31): **C 323 passing /
0 failing / 2 refused / 0 not-yet**, over a 380-file total (13 library, 1 fixture, 33 negative).
...
new refusal *among the 380* is a regression, not a backlog item, and should be read that way.
