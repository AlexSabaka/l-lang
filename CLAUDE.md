...
examples/       366 .lisp programs. This is the end-to-end suite, not a demo folder.
...
Baseline to hold, measured at D112 (2026-07-30): **C 311 passing / 0 failing / 2 refused / 0
not-yet**, over a 366-file total (13 library, 1 fixture, 31 negative). Any movement is a finding —
