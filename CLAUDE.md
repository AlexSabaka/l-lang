...
examples/       386 .lisp programs. This is the end-to-end suite, not a demo folder.
...
Baseline to hold, measured at the untyped-form census (2026-07-31): **C 327 passing /
0 failing / 2 refused / 0 not-yet**, over a 386-file total (13 library, 1 fixture, 35 negative).
...
new refusal *among the 386* is a regression, not a backlog item, and should be read that way.
