...
examples/       376 .lisp programs. This is the end-to-end suite, not a demo folder.
...
Baseline to hold, measured at the catch-arm traversal fix (2026-07-31): **C 321 passing /
0 failing / 2 refused / 0 not-yet**, over a 376-file total (13 library, 1 fixture, 31 negative). Any movement is
...
new refusal *among the 376* is a regression, not a backlog item, and should be read that way.
