...
examples/       377 .lisp programs. This is the end-to-end suite, not a demo folder.
...
0 failing / 2 refused / 0 not-yet**, over a 377-file total (13 library, 1 fixture, 31 negative). Any movement is
...
new refusal *among the 377* is a regression, not a backlog item, and should be read that way.
