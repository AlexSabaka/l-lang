...
examples/       381 .lisp programs. This is the end-to-end suite, not a demo folder.
...
Baseline to hold, measured at the pipeline-combination guard (2026-07-31): **C 324 passing /
0 failing / 2 refused / 0 not-yet**, over a 381-file total (13 library, 1 fixture, 33 negative).
...
new refusal *among the 381* is a regression, not a backlog item, and should be read that way.
