...
examples/       363 .lisp programs. This is the end-to-end suite, not a demo folder.
docs/spec/      DECISIONS.md is the spec. Rulings D1–D109.
```
...
Baseline to hold, measured at the sibling-collision fix (2026-07-30): **C 309 passing / 0 failing /
2 refused / 0 not-yet**, over a 363-file total (13 library, 1 fixture, 30 negative). Any movement is a finding —
