...
examples/       382 .lisp programs. This is the end-to-end suite, not a demo folder.
...
Baseline to hold, measured at the enum-combination guard (2026-07-31): **C 325 passing /
0 failing / 2 refused / 0 not-yet**, over a 382-file total (13 library, 1 fixture, 33 negative).
...
new refusal *among the 382* is a regression, not a backlog item, and should be read that way.
